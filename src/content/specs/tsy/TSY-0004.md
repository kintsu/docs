...
Enums provide type-safe representations of categorical data. This TSY documents the exact syntax and validation semantics so schema authors and code generators can rely on consistent enum behaviour. The discriminant assignment algorithm is normative — implementations must assign values deterministically to ensure interoperability.
