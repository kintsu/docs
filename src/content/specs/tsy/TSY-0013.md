...
Tagging attributes use the metadata system defined in [RFC-0012](/specs/rfc/rfc-0012).
...
```kintsu
#[tag(type_hint)]              // Explicit type_hint (default behaviour)
...
```json
// Active -> "active"
{ "state": "active", "started_at": "2025-12-25T10:00:00Z" }

// InProgress -> "in_progress" (PascalCase to snake_case)
{ "state": "in_progress", "percent": 75 }

// Complete -> "complete"
{ "state": "complete", "finished_at": "2025-12-25T12:00:00Z" }
