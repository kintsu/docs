...
4. Complex fields MUST have explicit form with precision parameter
...
> [!IMPORTANT]
> Form metadata is validated against field types. Invalid format-type combinations produce compilation errors. See [TSY-0015](/specs/tsy/tsy-0015) for detailed format rules.
