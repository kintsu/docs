...
Struct types are the canonical composite type in Kintsu. The TSY text below defines field syntax, optionality, field metadata, and validation expectations for struct types. Anonymous struct promotion and union merging are described in separate TSY specs ([TSY-0003](/specs/tsy/tsy-0003) and [TSY-0007](/specs/tsy/tsy-0007) respectively); this document limits itself to the structural rules for `struct` declarations.
