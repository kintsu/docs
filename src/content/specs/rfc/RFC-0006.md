...
Future changes to alias resolution behaviour (e.g., supporting conditional aliasing or generic aliases) would require separate RFCs and coordination with code generators.
...
- [TSY-0002](/specs/tsy/tsy-0002) - Struct types (for union/anonymous struct context)
- [TSY-0007](/specs/tsy/tsy-0007) - Union types (for union alias behaviour)
