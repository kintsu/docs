...
This section summarizes the user-facing syntax and the canonical behaviours the compiler implements. Detailed, normative rules appear in [TSY-0002](/specs/tsy/tsy-0002) and [SPEC-0002](/specs/spec/spec-0002).
...
Note: anonymous structs, union merging and merged-struct synthesis are documented in their own specifications ([RFC-0003](/specs/rfc/rfc-0003) / [TSY-0003](/specs/tsy/tsy-0003) / [SPEC-0003](/specs/spec/spec-0003) and [RFC-0007](/specs/rfc/rfc-0007) / [TSY-0007](/specs/tsy/tsy-0007) / [SPEC-0007](/specs/spec/spec-0007)). This RFC is intentionally focused on the struct type itself.
