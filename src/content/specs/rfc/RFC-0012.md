...
- [RFC-0005](/specs/rfc/rfc-0005) - Error types (uses error metadata)
- [RFC-0009](/specs/rfc/rfc-0009) - Operations (uses error metadata)
- [RFC-0010](/specs/rfc/rfc-0010) - Namespace system (uses version metadata)
