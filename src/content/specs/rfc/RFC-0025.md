...
```text title="kintsu remove output"
...
```text title="kintsu update output"
  Updating schema.lock.toml
...
```text title="kintsu update --force"
  Updating schema.lock.toml
...
```text title="kintsu prune output"
...
```text title="kintsu publish error"
