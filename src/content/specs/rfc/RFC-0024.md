...
updates:
  - author: joshua-auchincloss
    date: 2025-12-27
    description:
      Added all inheritable fields (authors, keywords, homepage, repository),
      file configuration with extend/override, path resolution rules, RFC-0019 conformance
      requirement
  - author: joshua-auchincloss
    date: 2025-12-26
    description:
      Changed to [alias.package] syntax, added workspace inheritable fields
