...
name = "external-types"
version = "1.0.0"
checksum = "sha256:gitchecksum..."
source = { git = "https://github.com/acme/external", rev = "abc123def456789" }
dependencies = [
{ name = "kintsu-std", provides = ["errors"], chain = ["external-types"] }
]
...
- Running `kintsu build` with no existing lockfile
...
- `kintsu build` - Use lockfile as-is, fail on mismatch
