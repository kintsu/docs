...
updates:
  - author: joshua-auchincloss
    date: 2025-12-28
    description: Added category 7 (Suppressed), KFM domain, error suppression mechanism
  - author: joshua-auchincloss
    date: 2025-12-26
    description: Added KWS (Workspace) and KCL (CLI) domains
  - author: joshua-auchincloss
    date: 2025-12-25
...
| `WS` | Workspace       | [ERR-0015](/specs/err/err-0015) | Workspace manifest and resolution           |
| `CL` | CLI             | [ERR-0016](/specs/err/err-0016) | Command-line interface operations           |
| `FM` | Form Metadata   | [ERR-0018](/specs/err/err-0018) | Form attributes and format specification    |
...
| `7`   | Suppressed    | Warning suppressed via #[allow(...)] | `KFM7001`: GlobalCompositionalDefault       |
...
| **Suppressed** | Category 7        | Succeeds    | `--verbose` only | Shown        |
...
**Suppressed**: A warning that has been acknowledged via `#[allow(...)]` attribute. Shown only with `--verbose` to confirm suppression is active.
...
Certain warnings can be suppressed using `#[allow(...)]` attributes. When suppressed, the diagnostic's category changes from 8 (Warning) to 7 (Suppressed) and severity becomes Info-level.

### Suppressible Errors

By default, only category 8 (Warning) errors are suppressible. Individual error specifications may mark specific validation errors as suppressible.
...
Error names for `#[allow(...)]` are derived from PascalCase error names by converting to snake_case:
...
1. Error code category digit changes from `8` to `7`
2. Severity changes from Warning to Info
3. Diagnostic only shown with `--verbose` flag
...
- Category 0 (Syntax): Structural errors
- Category 1 (Resolution): Unresolved references
- Category 2 (Validation): Semantic violations (unless explicitly marked)
- Category 3 (Conflict): Duplicate definitions
- Category 4 (Missing): Required elements absent
- Category 5 (Cycle): Circular dependencies
- Category 6 (Compatibility): Version incompatibilities
- Category 9 (Internal): Compiler bugs

For design rationale, see [RFC-0023](/specs/rfc/rfc-0023).
...
| KWS    | KWS0001     | KWS9999   | ~10       |
| KCL    | KCL0001     | KCL9999   | ~15       |
| KFM    | KFM0001     | KFM9999   | ~25       |
...
| Resolution 9   | KFM           | Form attribute validation             |
| Registration   | KTR, KTY      | Type registry population              |
| Configuration  | KPK, KWS      | Manifest/lockfile processing          |
| CLI            | KCL           | Command-line interface operations     |
...
- [ERR-0002](/specs/err/err-0002) - Lexical Errors
- [ERR-0003](/specs/err/err-0003) - Parsing Errors
- [ERR-0004](/specs/err/err-0004) - Namespace Errors
- [ERR-0005](/specs/err/err-0005) - Type Definition Errors
- [ERR-0006](/specs/err/err-0006) - Type Resolution Errors
- [ERR-0007](/specs/err/err-0007) - Union Errors
- [ERR-0008](/specs/err/err-0008) - Metadata Errors
- [ERR-0009](/specs/err/err-0009) - Tagging Errors
- [ERR-0010](/specs/err/err-0010) - Type Expression Errors
- [ERR-0011](/specs/err/err-0011) - Package Errors
- [ERR-0012](/specs/err/err-0012) - Registry Errors
- [ERR-0013](/specs/err/err-0013) - Filesystem Errors
- [ERR-0014](/specs/err/err-0014) - Internal Errors
