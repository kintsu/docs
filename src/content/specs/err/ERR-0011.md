...
```text title="KPK4004 example"
error[KPK4004]: failed to read file './LICENSE' for license-text: invalid UTF-8
  --> schema.toml:8:16
   |
 8 | license-text = { path = "./LICENSE" }
   |                ^^^^^^^^^^^^^^^^^^^^^^ file read error
   |
