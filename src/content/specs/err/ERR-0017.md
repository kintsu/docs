...
**Help:** Released schemas (`≥1.0.0`) can only depend on other released schemas. Either wait for the dependency to release `1.0.0`, or keep your schema in pre-release.
